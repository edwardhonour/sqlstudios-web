...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, VertSideNavComponent, Ng2SearchPipeModule, RouterModule, SitebarWrapperComponent,
  ...
  styleUrls: ['./threat-panel.component.css']
})
export class ThreatPanelComponent  implements OnInit {
