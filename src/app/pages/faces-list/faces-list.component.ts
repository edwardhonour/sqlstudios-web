...
@Component({
  ...
  imports: [CommonModule, VertSideNavComponent, SurveyTableComponent,
    ...
    FormsModule],
  templateUrl: './faces-list.component.html',
  styleUrls: ['./faces-list.component.css']
})
export class FacesListComponent implements OnInit, OnDestroy
{
  ...
  postForm() {
    this._dataService.postForm("post-face", this.data.formData).subscribe((data:any)=>{
//        this.data=data;
      location.reload();
     });
  }
