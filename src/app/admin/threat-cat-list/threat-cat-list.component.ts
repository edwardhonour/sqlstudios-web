...
@Component({
  ...
  imports: [CommonModule, VertSideNavComponent, 
    ...
    FormsModule],
  templateUrl: './threat-cat-list.component.html',
  styleUrls: ['./threat-cat-list.component.css']
})
export class ThreatCatListComponent implements OnInit, OnDestroy
{
